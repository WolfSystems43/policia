		...
		*/
        ...
        $this->crud->addField([
            ...
            'options'     => [ // the key will be stored in the db, the value will be shown as label;
                                ...
                                2 => "Agente/Guardia",
                                3 => "Agente de Segunda/Guardia de Segunda",
                                4 => "Agente de Primera Clase/Guardia de Primera",
                                5 => "Suboficial/Cabo",
                                6 => "Oficial en Prácticas/Sargento",
                                7 => "Oficial Técnico/Brigada",
                                8 => "Oficial Facultativo/Subteniente",
                                9 => "Oficial de Policía/Alférez",
                                10 => "Subinspector/Teniente",
                                11 => "Capitán/Capitán (Mando)",
                                12 => "Inspector/Comandante (Mando)",
                                13 => "Inspector Jefe/Teniente Coronel (Mando)",
                                14 => "Subcomisario/Coronel (Mando)",
                                15 => "Comisario/General (Mando)",
                                16 => "Comisario/Teniente Coronel (Mando)",
                            ],
            // optional
            //'inline'      => false, // show the radios all on the same line?
        ]);
